...
- Acrescentado um item de cura usável no inventário (mostrado na interface do jogo como o jogador irá utilizar esse objeto);
- Usados itens e update na interface.
